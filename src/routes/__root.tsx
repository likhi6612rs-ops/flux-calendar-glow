...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#9575CD" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "Flux" },
      { property: "og:title", content: "Flux — Dynamic Personal Nervous System" },
      { property: "og:description", content: "Visualize daily consistency and gamify discipline." },
